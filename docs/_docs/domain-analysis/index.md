...
4. [Bounded Contexts](bounded-contexts/index.md)
    ...
    4. [Stocking](bounded-contexts/stocking.md)
    5. [Restocking](bounded-contexts/restocking.md)
    6. [Client Orders](bounded-contexts/client-orders.md)
    7. [Pricing](bounded-contexts/pricing.md)
    8. [Shared Kernel](bounded-contexts/shared-kernel.md)
